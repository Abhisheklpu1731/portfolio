          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Abhisheklpu1731/Telco-Churn-Prediction-Project-using-ML-and-Data-science-.git" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /></a>
                </div>
            </header>
            <div className="body">
              <h3>Churn Prediction Project using Machine learning</h3>
              <p>This project predicts customer churn in a telecommunications company using machine learning techniques. It involves data loading, preprocessing, exploratory data analysis (EDA), feature engineering, model building, and evaluation. Key steps include environment setup, data preprocessing, EDA, feature engineering, model training, and visualization of results. </p>
              </div>
            <footer> <ul className="tech-list"> <li>ML classification models</li> <li>Data handling</li> <li>Matplotlib</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/Abhisheklpu1731/Boston-House-predictions.git" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
            ...
            <div className="body">
              ...
              <p>
              The the goal of this project is to predict the housing prices of a town or a suburb based on the features of the locality provided to us.
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Abhisheklpu1731/Android-Thoughts-app-in-kotlin.git" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Thoughts App</h3>
              <p>This Android application is a simple yet powerful tool to keep track of your thoughts. Built using XML and Kotlin, it features a minimalist design with two fragments, a splash screen, and the ability to display new thoughts or retrieve previously saved ones from the internal storage.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Kotlin</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Abhisheklpu1731/multilang_deployment.git" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://abhimultilang.streamlit.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Multi-Language Translator using NLP and web(streamlit)</h3>
              <p>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
              <a href="https://github.com/Abhisheklpu1731/web_based_stopwatch.git" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://abhisheklpu1731.github.io/web_based_stopwatch/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
                </div>
            </header>
            <div className="body">
              <h3>Online Time Tracking Tool</h3>
              <p>
